...
<head>
  ...
  <link rel="stylesheet" crossorigin href="<?= BASE_URL ?>/assets/compiled/css/error.css">
</head>
...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            ...
            <p class="fs-5 text-gray-600">Bạn không có quyền truy cập vào trang này.</p>
            <a href="<?= BASE_URL ?>/home" class="btn btn-lg btn-outline-primary mt-3">Quay lại trang chủ</a>
        </div>
    </div>
</div>
