...
<head>
  ...
  <link rel="stylesheet" crossorigin href="<?= BASE_URL ?>/mazer/assets/compiled/css/error.css">
</head>
...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            <img class="img-error" src="<?= BASE_URL ?>/mazer/assets/compiled/svg/error-404.svg" alt="Not Found">
            <h1 class="error-title">Not Found</h1>
            <p class='fs-5 text-gray-600'>Trang không tồn tại.</p>
            <a href="<?= BASE_URL ?>/home" class="btn btn-lg btn-outline-primary mt-3">Quay về Trang Chủ</a>
        </div>
    </div>
</div>
